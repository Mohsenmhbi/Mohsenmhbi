...
## 👨‍💻 Tech Stack  
`C# | .NET | EF Core | CQRS | DDD | TDD | BDD | Event Sourcing | Kafka | RabbitMQ | MySQL | MongoDB | Redis | Elasticsearch | Docker | Kubernetes`

---

## 🧠 About Me  

I’m passionate about **DDD** and **event-driven architectures** — designing clean and modular systems using **.NET**, **Kafka**, and **CQRS**.  
I believe in writing code that’s **simple, testable, and future-proof**.
...
![EF Core](https://img.shields.io/badge/EF_Core-68217A?style=flat&logo=dotnet&logoColor=white)
...
📧 [mohsen.mhbi@gmail.com](mailto:mohsen.mhbi@gmail.com)  
